    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Tacocoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Tacocoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tacocoin network", "", count));
}
...
{
    QString strTitle = tr("Tacocoin"); // default title
